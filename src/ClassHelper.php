...
namespace ReindeerWeb\ClassHelper;
...
class ClassHelper
{
    ...
    public static function create()
    {
        ...
        if ($class == 'ReindeerWeb\\ClassHelper\\ClassHelper') {
     ...
     * @param bool $force When true, the new class don't need to be a child class of the old
     *
     ...
     *
     * @return string the class that would be created if you called {@link ClassHelper::create()} with the class
     */
